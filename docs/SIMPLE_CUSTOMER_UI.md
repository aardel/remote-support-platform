...
<body>
    ...
    <script>
        ...
        async function startVNCServer() {
            ...
            const response = await fetch('http://localhost:3000/api/vnc/start', {
                method: 'POST',
        ...
        async function connectReverse() {
            ...
            const response = await fetch(`http://localhost:3000/api/vnc/connect`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    sessionId,
        ...
        function disconnect() {
            fetch('http://localhost:3000/api/vnc/stop', {
                method: 'POST'
            });
