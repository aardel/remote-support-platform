/*==============================================================
   Maschinenkonstanten fuer PTS-Neo-V2/ENC66
   Version 1.42
   AG/St 05.10.2023 
================================================================*/
/* --------------
...
St 26.02.16   Jetzt mit aktiver B- Achse.
<--->*/
...
MK_ESABKONF                0,   /* Knoten 1: X-Achse  */
                           1,   /* Knoten 2: Y-Achse  */
                           2,   /* Knoten 3: Z-Achse  */
                           4,   /* Knoten 4: A-Achse  */
                           4,   /* Knoten 5: A1-Achse */
                           5,   /* Knoten 6: U-Achse [X1] */
                           6,   /* Knoten 7: V-Achse [Z1] */
                           7,   /* Knoten 8: B-Achse = Scannerachse  */
                          -1,
                          -1,
                          -1,
                          -1,
...
MK_ACHSENART               2,   /* Definition der Achse (bit-codiert)                         */
                        ...
                        1091,   /*          10 Messachse,   11 Spindel & Messachse            */
                           ...
                           2,   /*          11 Modulo 360>-Achse, kürzester Weg wird gefahren */
                           2,   /* Bit 6  : Gantryachse (Wert 64)                             */
                           2,   /* Bit 7  : Handrad                                           */
...
/*-------------------------------------------*/
MK_VOREINSTELLUNG         "G24;G25;G26 X0 Y0 Z0 A0 U0 V0 B0;G17;G122 X1;G60 X0 E7;G90;G175;T0";  /* für Initialisierung nach Reset oder Programmende */
...
MK_METRISCH                1;   /* 1 = Weg- und Geschwindigkeitseingaben im metrischen System [mm] bzw. [mm/min] */
...
MK_LAH_GRENZWINKEL         5;   /* Übergangswinkel ab dem zwangsweise bis zum Stillstand gebremst werden soll */
...
MK_REF_RICHTUNG_UND_FOLGE  2,   /* Richtung der Achse bei Start der Referenzpunktfahrt     */
                           1,   /* sowie Reihenfolge bei automatischer Referenzpunktfahrt  */
                           2,   /*  0 => Achse ist nicht beteiligt                         */
                           0,   /*  X => pos. Richtung                                     */
                           0,   /* -X => neg. Richtung                                     */
                           2,
                           2,
...
MK_VMAX                   30,   /* max. Achsgeschwindigkeit [m/min] bzw. [U/min]   */
...
MK_BESCHL                0.7,   /* Beschleunigungsrampe [m/sec^2] bzw. [U/sec^2] */
                         4.0,
                           5,
                           1,
                           1,
...
MK_BREMS                 1.1,   /* Bremsrampe [m/sec^2] bzw. [U/sec^2] */
                         4.5,
                           5,
                           1,
                           1,
...
MK_T_BESCHL               50,   /* Dämpfungszeitkonstante für Beschleunigungs- und Bremsrampen [ms] */
                          50,
                          20,
                           0,
                          50,
...
/*-----------------------------*/
MK_VBAHNMAX             42.3;   /* max. Bahngeschwindigkeit [m/min] */

MK_BAHNBESCHL            4.0;   /* Beschleunigungsrampe [m/sec^2] */

MK_BAHNBREMS             5.0;   /* Bremsrampe [m/sec^2] */

MK_T_BAHNBESCHL           60;   /* Dämpfungszeitkonstante für Brems- und Beschleunigungsrampen [ms] */
...
MK_TECHNOLOGIEDATEN1       5,   /* P760 = Machinetyp 1:MTL 2:CLS 3:PTS 4:ProRot 5:PTSNeo 6:FBL */
                           0,   /* P761 = Nachlaufzeit [sec] für Absaugung */
                     ...
                     23.17,   /* P764 = Abstand Laserdüse zu Fußunterkante [mm od. inch] */
                    18.83,   /* P765 = Abstand Fokuspunkt zu Fußunterkante [mm od. inch] */
                        ...
                        2000,   /* P768 = Zielposition beim Freifahren od. Wechselpos. der X-Achse [mm od. inch] */
                        1900;   /* P769 = Zielposition beim Freifahren od. Wechselpos. der Y-Achse [mm od. inch] */

/* Anwendungsspezifische Technologieparameter, die ab P770 im Parameterfeld abgelegt werden */
MK_TECHNOLOGIEDATEN2     -89,   /* P770 = Z-Offset Rotation [mm od. inch] */
                         400,   /* P771 = Sicherheitsabstand Y <--> U [mm od. inch] */
                           0,   /* P772 = */
                           5,   /* P773 = sichere Position der Z-Achse (bezogen auf Abstand zum pos. Softwarelimit) [mm od. inch] */
                         ...
                         400,   /* P777 = Verweilzeit [ms] nach M122 (Schutter auf) */
                       42300,   /* P778 = max. Bahngeschwindigkeit [mm/min od. inch/mim] muß gleich MK_VBAHNMAX sein */
...
MK_TECHNOLOGIEDATEN3      -4,   /* P780 = Neg. Vergleichswert fuer akt. Pos. Messgeber Fuss [mm od. inch]im %9200  */
                           4,   /* P781 = Pos. Vergleichswert fuer akt. Pos. Messgeber Fuss [mm od. inch]im %9200  */
                           3,   /* P782 = Sichere Z-Achs-Höhe in mm oder inch über der Materialoberfl. für sich. Leerverfahren */
                          -1,   /* P783 = Neg. Softwarelimit für Y-Achse im Flachbettbetrieb */
                      -583.1,   /* P784 = Y-Offset für Rotation - ATTENTION: The control must be rebooted after changing this value */
                        90.0,   /* P785 = A-Offset (zum Beladen) */
                        50.0,   /* P786 = A-Pos-Negativ Entspannen erlaubt */
                       130.0,   /* P787 = A-Pos-Positiv Entspannen erlaubt */
                       12000,   /* P788 = Zeitkonstante für Spülen in Bar pro ms */
                         15;   /* P789 = b0: Flachbett Laser; b1: Rotation Laser; b2: Rotation Fräser b3: Werkzeugwechsel */

/* Anwendungsspezifische Technologieparameter, die ab P790 im Parameterfeld abgelegt werden */
MK_TECHNOLOGIEDATEN4     250,   /* P790 = ScannerGravur: Z-Position */
                          15,   /* P791 = ScannerGravur: Laserprogrammnummer */
                        -301,   /* P792 = ScannerGravur: Erweiterung Softwarelimit Y-. bei Flachbett */
                        1501,   /* P793 = ScannerGravur: Erweiterung Softwarelimit Y+. bei Flachbett */
                         ...
                         0.0,   /* P796 = Fokuslagenkorrektur für Stahl in mm */
                        ...
                        1000;   /* P799 = Geschwindigkeit für Fräser absenken (mm/min) */
...
MK_DW224_255           30000,   /* DW 224: MMI Überwachung Timeoutzeit [ms] */
                         ...
                         500,   /* DW 226: Wartezeit für Abfrage Schneidgas ok (mit M108) [ms] */
                           0,   /* DW 227: */
                           0,   /* DW 228: */
                          10,   /* DW 229: Nachlaufzeit Scanner-Absaugung [s] */
                          10,   /* DW 230: Nachlaufzeit Absaugung [s] */
                         500,   /* DW 231: Einschalt-Verzögerung Absaugungen [ms] */
                           7,   /* DW 232: Absaugung Flachbett = 7 (Standard) / Bit0 = Absaugung Scanner; Bit1 = Absaugung Flachbett_1; Bit2 = Absaugung Flachbett_2; Bit3 = Absaugung Rotation;*/
                           9,   /* DW 233: Absaugung Rotation  = 9 (Standard) / Bit0 = Absaugung Scanner; Bit1 = Absaugung Flachbett_1; Bit2 = Absaugung Flachbett_2; Bit3 = Absaugung Rotation; */
                           0,   /* DW 234: */
                           0,   /* DW 235: */
                           0,   /* DW 236: */
                           0,   /* DW 237: */
                           ...
                           0,   /* DW 242: */
                           0,   /* DW 243: */
                         204,   /* DW 244: BIT0:nicht benutzt, Bit1:Schraubautomat, Bit2:Drehmagazin, Bit3:Erfassung Spindelleistung, Bit4:Schraubautomat simulieren, Bit5:Lichtschranken an Portal, Bit6:Spannzangen-Sensor, Bit7:Lichtschranke Tischumrandung, Bit8:Service-Tür, Bit9:DIL-Magazin, b10:Deprag-Schrauber,  b11: 2.ServiceTür, b12: Taster mit OverdriveSchutz */
                           0,   /* DW 245: */
                           0,   /* DW 246: */
                           0,   /* DW 247: Bit2 = 1 3D-Messtaster vorhanden, Bit3 = 1 3D-Messtaster ist an der Z-Achse */
                           7,   /* DW 248: Bit0 = 1 (Flachbett-Scanner vorhanden) / Bit1 = 1 (Rotatios-Scanner vorhanden) / Bit2 = 1 (Abdeckhaube nicht vorhanden) / Bit3 = 1 (Linsenschutz vorhanden )  */
                           1,   /* DW 249: Bit1 = 0 (Status Wasserkühler / E0.5) negieren; Bit1 = 1 (Fehler 0: Ok) */
                           0,   /* DW 250: */
                           0,   /* DW 251: Bit0 = 0 (Lichtgitter FIESSLER); Bit0 = 1 (Lichtgitter OMRON/Sick), Bit1: Warnfeldeingänge negieren, Bit2: 2 Warnfeldeingänge */
                           0,   /* DW 252: */
