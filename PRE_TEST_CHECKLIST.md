...
PORT=3000
SERVER_URL=https://your-domain.example/remote
```
...
**Via API:**
```bash
curl -X POST https://your-domain.example/remote/api/auth/register \
...
```bash
# Health check
curl https://your-domain.example/remote/api/health
...
- Open: https://your-domain.example/remote/support/ABC-123-XYZ (Customer UI - replace with actual session ID)
...
### Backend Tests
- [ ] Health check works: `curl https://your-domain.example/remote/api/health`
...
- [ ] Login page displays
- [ ] Customer UI loads (https://your-domain.example/remote/support/SESSION-ID)
